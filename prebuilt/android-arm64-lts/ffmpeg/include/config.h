...
#define FFMPEG_CONFIGURATION "--prefix=/home/pisces312/android_build/arm64-v8a --target-os=android --arch=aarch64 --cpu=armv8-a --cc=/home/pisces312/android-ndk-r25b/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android24-clang --cxx=/home/pisces312/android-ndk-r25b/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android24-clang++ --strip=/home/pisces312/android-ndk-r25b/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-strip --enable-cross-compile --disable-debug --enable-static --enable-shared --enable-small --enable-gpl --enable-nonfree --enable-neon --disable-doc --disable-ffplay --disable-everything --enable-libx264 --enable-libx265 --enable-libmp3lame --enable-encoder='libx264,libx265,aac,libmp3lame,flac,h264_v4l2m2m' --enable-decoder='h264,hevc,h264_v4l2m2m,hevc_v4l2m2m,aac,aac_latm,mp3,mp3float,flac' --enable-muxer='mp4,mov,matroska,avi,flv,flac' --enable-demuxer='mp4,mov,matroska,avi,flv,flac,aac,mp3' --enable-filter='scale,crop,trim,concat,volume,fade,rotate,transpose,overlay,format,fps,afade,acrossfade,aformat,atrim,volumedetect,cropdetect' --enable-protocol=file --enable-bsf='h264_mp4toannexb,hevc_mp4toannexb,aac_adtstoasc' --enable-parser='h264,hevc,aac,mpegaudio,flac' --enable-swscale --enable-swresample --enable-avfilter --enable-avformat --enable-avcodec --enable-avutil --extra-cflags='-O3 -Wall -fPIE -fPIC -I/home/pisces312/android_build/arm64-v8a-minimal/include' --extra-ldflags='-pie -L/home/pisces312/android_build/arm64-v8a-minimal/lib' --pkg-config-flags=--static"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2026
#define FFMPEG_DATADIR "/home/pisces312/android_build/arm64-v8a/share/ffmpeg"
#define AVCONV_DATADIR "/home/pisces312/android_build/arm64-v8a/share/ffmpeg"
